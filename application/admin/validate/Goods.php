...
class Goods extends Validate
{
    ...
    protected $rule = [
        ...
        'min_price' => ['require', 'regex' => '([1-9]\d*(\.\d*[1-9])?)|(0\.\d*[1-9])'],
        'max_price' => 'require|regex:\d{1,10}(\.\d{1,2})?$|checkMarketPrice',
...
//        'virtual_limit' => 'checkVirtualLimit',
    ...
    protected $message = [
        ...
        'min_price.require' => '本店售价必填',
        'min_price.regex' => '本店售价格式不对',
        'max_price.require' => '市场价格必填',
        'max_price.regex' => '市场价格式不对',
        'max_price.checkMarketPrice' => '市场价不得小于本店价',
        'weight.regex' => '重量格式不对',
        'series.require' => '请填写商品系列号'
