...
class NewsCatLogic extends Model
{
     ...
     * @return  mix
     */
    public function news_cat_list($cat_id = 0, $selected = 0, $re_type = true, $level = 0)
    {
        static $res = NULL;
        ...
        return $res;
//        $options = $this->news_cat_options($cat_id, $res); // 获得指定分类下的子分类的数组
//
//        /* 截取到指定的缩减级别 */
//        if ($level > 0)
//        {
...
//        }
     ...
     * @return  void
     */
    public function news_cat_options($spec_cat_id, $arr)
    {
